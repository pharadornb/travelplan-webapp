...
<div class="mt-5" align="center">
    ...
    <p><h5 style="font-weight: bold">ประกาศ!!</h5>
        username: <b>user</b> password: <b>5678</b><br/>
        username: <b>admin</b> password: <b>admin1234</b><br/>
        ->เข้าสู่ระบบและสมัครสมาชิกได้ รวมถึงการเข้ารหัส รหัสผ่าน<br/>
        ->หน้าผู้ดูแลระบบทำการเพิ่ม ลบ แต่ยังไม่สามารถแก้ไขได้<br/>
        ->สามารถลบบัญชีผู้ใช้ออกได้<br/>
        ->การใช้งานอาแจ็กซ์เพื่อการอัพเดตข้อมูลโดยไม่ต้องกดเรียลไทม์ดูได้แอดมิน-หน้าแรก<br/>
        ->จัดการแผนที่ได้แล้ว<br/>
    </p>
</div>
